...
df.loc[df['headline'].str.contains('breakout', case=False), 'price_movement_24h'] += np.random.normal(0.015, 0.005)
df.loc[df['headline'].str.contains('downgrade', case=False), 'price_movement_24h'] -= np.random.normal(0.015, 0.005)
