...
def test_multi_horizon_confidence_always_valid(c2: float, c5: float, c10: float) -> None:
    ...
    pred = MultiHorizonPrediction(
        predicted_return_2d=0.01, predicted_return_5d=0.02, predicted_return_10d=0.03,
        confidence_2d=c2, confidence_5d=c5, confidence_10d=c10,
    )
...
def test_multi_horizon_rejects_bad_confidence(bad_conf: float) -> None:
    try:
        MultiHorizonPrediction(
            predicted_return_2d=0.01, predicted_return_5d=0.02, predicted_return_10d=0.03,
            confidence_2d=bad_conf, confidence_5d=0.5, confidence_10d=0.5,
        )
        assert False, "Should have raised"
